...
# Set work directory
WORKDIR /home/alassane/django_react/

# Copy pipfile and change ower from host alassane to vm alassane
COPY --chown=alassane:alassane Pipfile Pipfile.lock /home/alassane/django_react/
...
COPY --chown=alassane:alassane . /home/alassane/django_react/
